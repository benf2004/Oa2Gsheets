...
// gets requested cookie by name
    ...
    function load_product(p){
        ...
        if (id('saver').checked !== true) {
            keepa.src = `https://api.keepa.com/graphimage?amazon=1&bb=1&fba=1&fbm=1&salesrank=1&width=420&height=200&cBackground=f8f9fa&key=${key}&domain=${d_id}&asin=${p['asin']}`
        }
        ru(keepa)
